...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function store(Request $request){
        ...
        if ($validate->fails()){
            return redirect(url($locale.'/signup'))->withErrors($validate);
        } else {
            $this->create([
    ...
    protected function validator(array $data)
    {
        return Validator::make($data, [
            ...
            'fullname.max' => 'Tên bạn không hợp lệ',
            ...
            'repeat_password.same' => 'Mật khẩu không trùng khớp',
            'repeat_password.required_with' => 'Hãy xác nhận mật khẩu',
        ]);
    }
